...
import errorImg from "../img/img-error.jpg";
import "./error404.css";

function Error404() {
  return (
    <div
      className="flex flex-col items-center justify-center min-h-screen bg-[#0f0f0f] text-white text-center bg-cover bg-center"
      style={{ backgroundImage: `url(${errorImg})` }}
    >
      <div className="rgb-anim">
        <h1 className="text-7xl mb-4 text-[#00ffff] drop-shadow-[0_0_15px_rgba(0,255,255,0.8)] font-bold">
          404
        </h1>
      </div>
      ...
      <p className="text-2xl mb-6">
        ...
        <span className="inline-block animate-jump drop-shadow-[0_0_10px_#00ffcc]">
          👾
        </span>
      </p>
