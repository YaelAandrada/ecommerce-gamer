...
//aca vamos a manejar el eliminado de la tarea
  const handleDelete = async () => {
    // Mostrar un toast de confirmación con botones
    ...
    // Abrir el toast con el componente de confirmación personalizado
